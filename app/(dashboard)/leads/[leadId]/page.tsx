                                    ...
                                    return (
                                        <React.Fragment key={`call-${index}`}>
                                            <tr className={`hover:bg-slate-50/50 dark:hover:bg-white/5 transition-all group ${isExpanded ? 'bg-slate-50/80 dark:bg-white/5' : ''}`}>
                                                ...
                                                <td className="px-8 py-6">
                                                    <span className={`inline-flex items-center text-[11px] font-bold uppercase tracking-tight ${call.status === 'completed'
                                                ...
                                                <td className="px-8 py-6 text-right">
                                                    <button
                                                        ...
                                                        className={`px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 ml-auto cursor-pointer shadow-sm ${isExpanded
